...
// 		/// Record account's btc and ethereum balance
	...
	pub(super) type CommitAccountBalance<T: Config> =  StorageDoubleMap<_, Blake2_128Concat, T::AccountId, Blake2_128Concat, QueryKey<T::AccountId>, Option<u32>, ValueQuery>;
