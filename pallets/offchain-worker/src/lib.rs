...
// The link is ETHER_SCAN_PREFIX + 1st Ethereum account + ETHER_SCAN_DELIMITER + 2nd Ethereum
// account + ... + ETHER_SCAN_POSTFIX + ETHER_SCAN_TOKEN
pub const ETHER_SCAN_PREFIX: &str =
    "https://api-ropsten.etherscan.io/api?module=account&action=balancemulti&address=0x";
...
pub trait Trait:
    frame_system::Trait + account_linker::Trait + CreateSignedTransaction<Call<Self>>
{
...
impl<T: Trait> Module<T> {
    ...
    fn fetch_etherscan_account(
        ...
        match balances {
            Some(data) => {
                ...
                for item in data {
                    let balance =
                        Self::chars_to_u64(item).map_err(|_| Error::<T>::InvalidNumber)?;
    ...
    fn parse_multi_balances(price_str: &str) -> Option<Vec<Vec<char>>> {
        ...
        // "result":
        //   [
        //     {"account":"0x742d35Cc6634C0532925a3b844Bc454e4438f44e","balance":"
        // 3804372455842738500000001"},     {"account":"
        // 0xBE0eB53F46cd790Cd13851d5EFf43D12404d33E8","balance":"2571179226430511381996287"}
        //   ]
        // }
